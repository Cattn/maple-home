...
<div class="flex justify-center items-center">
    <div class="fixed grid grid-cols-3 top-5 bg-primary w-[80%] rounded-4xl p-2">
        <div class="flex items-center gap-2">
            <Button variant="tonal" iconType="full" onclick={() => {goto("/")}}>
                <svg width="20" height="20" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 20px; height: 20px;">
        ...
        <div class="flex justify-center items-center gap-2">
            ...
            <Button variant="text" iconType="none" class="p-0" onclick={() => {goto("/about")}}>
                <h1 class="text-on-secondary roboto-flex-home-link">about</h1>
            </Button>
            <Button variant="text" iconType="none" class="p-0" onclick={() => {goto("/contact")}}>
                <h1 class="text-on-secondary roboto-flex-home-link">contact</h1>
            </Button>
        </div>
        <div class="flex justify-end items-center">
            <Button onclick={() => {location.href = 'https://github.com/Cattn/Maple'}} variant="tonal" iconType="full">
